...
export default function SynthKnob({ label, value = 0, color = "#4ecdc4", unit = "" }) {
      ...
      <div className="relative" style={{ width: SIZE, height: SIZE }}>
        <svg width={SIZE} height={SIZE} className="block">
          ...
          <circle
            ...
            transform={`rotate(${ARC_START * 360}, ${SIZE / 2}, ${SIZE / 2})`}
          />
          <circle cx={SIZE / 2} cy={SIZE / 2} r={14} className="knob-dot" />
        </svg>
        <div
          className="absolute inset-0 flex items-center justify-center text-[9px] font-mono font-medium"
